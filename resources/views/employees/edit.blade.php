                ...
                <div class="rounded-xl border border-slate-200 p-4">
                    ...
                    <label class="flex items-start gap-3 cursor-pointer" for="is_remote_worker">
                        ...
                        <span>
                            ...
                            <span class="text-xs text-slate-500">يمكن لهذا الموظف تسجيل حضور وانصراف اونلاين من موقع واحد أو موقعين معتمدين.</span>
                        </span>
                    </label>
            ...
            <div id="remote-locations-section" class="space-y-3 {{ $isRemoteWorker ? '' : 'hidden' }}">
                ...
                @if(($locations ?? collect())->isNotEmpty())
                    <div class="form-group mb-0">
                        ...
                        <p class="mt-1.5 text-xs text-slate-400">يمكن اختيار موقع واحد أو موقعين فقط للدوام الاونلاين.</p>
