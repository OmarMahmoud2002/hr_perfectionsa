...
@section('page-subtitle', 'تحديد موقع الحضور على الخريطة')
...
<nav class="breadcrumb">
    ...
    <span class="text-slate-700 font-medium">إضافة موقع جديد</span>
</nav>
    ...
    <div class="card overflow-hidden">
        ...
        <div class="px-6 py-5 border-b border-slate-100"
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-bold text-slate-800">بيانات الموقع</h2>
                    <p class="text-xs text-slate-500">اختر النقطة من الخريطة وحدد نصف القطر بالمتر</p>
                </div>
            </div>
        </div>

        <form action="{{ route('locations.store') }}" method="POST" class="p-6 space-y-5"
              data-loading="true" data-loading-target="#create-location-submit" data-loading-text="جاري الحفظ...">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="form-group mb-0">
                    ...
                    <input type="text" id="longitudeInput" name="longitude"
                           value="{{ old('longitude', '31.2357000') }}"
            ...
            <div class="form-group mb-0">
                <label for="savedLocationSelect" class="form-label">إعادة استخدام موقع محفوظ</label>
                ...
                <p class="mt-1.5 text-xs text-slate-400">عند اختيار موقع محفوظ سيتم تعبئة الإحداثيات ونطاق السماح تلقائياً.</p>
            </div>
            @endif
            ...
            <div class="form-group mb-0">
                ...
                <p class="mt-1.5 text-xs text-slate-400">اكتب اسم المكان ثم اختره من الاقتراحات لنقل المؤشر مباشرة.</p>
            </div>

            <div id="location-map" class="rounded-2xl border border-slate-200 overflow-hidden" style="height: 430px;"></div>

            <div class="flex items-center gap-3 pt-2 border-t border-slate-100">
                <button type="submit" id="create-location-submit" class="btn-primary btn-lg flex-1 justify-center">
